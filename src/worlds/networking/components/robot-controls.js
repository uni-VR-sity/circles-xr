...
AFRAME.registerComponent('robot-controls', {
    ...
    createButtonAndRobotConnections: function() {
        ...
        // Animate shoulder
        CONTEXT_AF.shoulderControls.overButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.OVER_BACK, CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.shoulderControls.overButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.OVER_BACK, 0.0); 
        });
        
        CONTEXT_AF.shoulderControls.backButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.OVER_BACK, -CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.shoulderControls.backButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.OVER_BACK, 0.0); 
        });
        
        CONTEXT_AF.shoulderControls.leftButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, -CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.shoulderControls.leftButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, 0.0); 
        });
        
        CONTEXT_AF.shoulderControls.rightButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.shoulderControls.rightButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.SHOULDER, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, 0.0); 
        });

        // Animate elbow
        CONTEXT_AF.elbowControls.overButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.OVER_BACK, CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.elbowControls.overButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.OVER_BACK, 0.0); 
        });
        
        CONTEXT_AF.elbowControls.backButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.OVER_BACK, -CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.elbowControls.backButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.OVER_BACK, 0.0); 
        });
        
        CONTEXT_AF.elbowControls.leftButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, -CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.elbowControls.leftButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, 0.0); 
        });
        
        CONTEXT_AF.elbowControls.rightButton.addEventListener('mousedown', function() { 
            CONTEXT_AF.isMouseDown = true; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, CONTEXT_AF.data.rotationIncrementRad); 
        });
        
        CONTEXT_AF.elbowControls.rightButton.addEventListener('mouseup', function() { 
            CONTEXT_AF.isMouseDown = false; 
            CONTEXT_AF.rotateElem(CONTEXT_AF.JOINT_TYPE.ELBOW, CONTEXT_AF.ROT_TYPE.LEFT_RIGHT, 0.0); 
        });
    }
