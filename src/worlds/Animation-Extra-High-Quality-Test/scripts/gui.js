...
{
    var targets = document.getElementById('agent').getObject3D('mesh').children[0].children[0].morphTargetDictionary;
    console.log(targets);
};
...
obj['AA'] = function() 
{
    document.getElementById('agent').getObject3D('mesh').children[0].children[0].morphTargetInfluences[1] = 1;

    document.getElementById('agent').getObject3D('mesh').children[0].children[5].children[0].morphTargetInfluences[1] = 1;
    document.getElementById('agent').getObject3D('mesh').children[0].children[5].children[1].morphTargetInfluences[1] = 1;

    document.getElementById('agent').getObject3D('mesh').children[0].children[7].children[0].morphTargetInfluences[1] = 1;
    document.getElementById('agent').getObject3D('mesh').children[0].children[7].children[1].morphTargetInfluences[1] = 1;
};
