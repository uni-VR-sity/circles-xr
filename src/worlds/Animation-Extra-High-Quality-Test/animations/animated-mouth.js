AFRAME.registerComponent('animated-mouth', {
    ...
    stateHandler: async function (state){
      ...
      createMorphTargets: async function (context){
        ...
        context.el.setAttribute('morph-targets__BMP', {target: 20, value: 0});
        context.el.setAttribute('morph-targets__FF', {target: 17, value: 0});
        context.el.setAttribute('morph-targets__TH', {target: 16, value: 0});
        context.el.setAttribute('morph-targets__TLDN', {target: 18, value: 0});
        context.el.setAttribute('morph-targets__KK', {target: 19, value: 0});
        context.el.setAttribute('morph-targets__CH', {target: 15, value: 0});
        context.el.setAttribute('morph-targets__SS', {target: 14, value: 0});
        context.el.setAttribute('morph-targets__RR', {target: 12, value: 0});
        context.el.setAttribute('morph-targets__AA', {target: 1, value: 0});
        context.el.setAttribute('morph-targets__E', {target: 3, value: 0});
        context.el.setAttribute('morph-targets__I', {target: 5, value: 0});
        context.el.setAttribute('morph-targets__O', {target: 7, value: 0});
        context.el.setAttribute('morph-targets__U', {target: 6, value: 0});
    },
