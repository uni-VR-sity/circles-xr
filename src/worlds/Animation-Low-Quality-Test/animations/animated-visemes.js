AFRAME.registerComponent('animated-visemes', {
    ...
    createAnimations: async function (context){
        ...
        context.el.setAttribute('animation__TH-1', { property: 'morph-targets__FV.value', to: 1, loop: false, dur: 100, autoplay: false, startEvents: 'viseme-TH'});
        ...
        context.el.setAttribute('animation__SS-1', { property: 'morph-targets__FV.value', to: 1, loop: false, dur: 100, autoplay: false, startEvents: 'viseme-SS'});
        ...
        context.el.setAttribute('animation__I-1', { property: 'morph-targets__E.value', to: 1, loop: false, dur: 100, autoplay: false, startEvents: 'viseme-I'});
