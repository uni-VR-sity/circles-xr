AFRAME.registerComponent('animated-mouth', {
    ...
    stateHandler: async function (state){
      ...
      createMorphTargets: async function (context){
        ...
        context.el.setAttribute('gltf-morph__mouthRollLower', {morphtarget: 'ChinLowerRaise', value: 0});
        context.el.setAttribute('gltf-morph__mouthRollUpper', {morphtarget: 'ChinUpperRaise', value: 0});
        ...
        context.el.setAttribute('gltf-morph__mouthPressRight', {morphtarget: 'MouthPress_R', value: 0});
        context.el.setAttribute('gltf-morph__mouthPressLeft', {morphtarget: 'MouthPress_L', value: 0});
        context.el.setAttribute('gltf-morph__mouthStretchRight', {morphtarget: 'LipsStrech_R', value: 0});
        context.el.setAttribute('gltf-morph__mouthStretchLeft', {morphtarget: 'LipsStrech_L', value: 0});
        context.el.setAttribute('gltf-morph__mouthUpperUpRight', {morphtarget: 'LipsUpperUp_R', value: 0});
        context.el.setAttribute('gltf-morph__mouthUpperUpLeft', {morphtarget: 'LipsUpperUp_L', value: 0});
        context.el.setAttribute('gltf-morph__mouthLowerDownRight', {morphtarget: 'LipsLowerDown_R', value: 0});
        context.el.setAttribute('gltf-morph__mouthLowerDownLeft', {morphtarget: 'LipsLowerDown_L', value: 0});
        context.el.setAttribute('gltf-morph__mouthFrownRight', {morphtarget: 'MouthFrown_R', value: 0});
        context.el.setAttribute('gltf-morph__mouthFrownLeft', {morphtarget: 'MouthFrown_L', value: 0});
        context.el.setAttribute('gltf-morph__mouthRight', {morphtarget: 'MouthRight', value: 0});
